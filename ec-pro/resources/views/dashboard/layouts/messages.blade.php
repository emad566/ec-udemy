                ...
                <div class="message-center">
                    ...
                    <a href="javascript:void(0)">
                        <div class="user-img"> <img
                                src="{{ asset('assets/dashboard/eliteadmin-theme/assets/images/users/1.jpg') }}"
                    ...
                    <a href="javascript:void(0)">
                        <div class="user-img"> <img
                                src="{{ asset('assets/dashboard/eliteadmin-theme/assets/images/users/2.jpg') }}"
                    ...
                    <a href="javascript:void(0)">
                        <div class="user-img"> <img
                                src="{{ asset('assets/dashboard/eliteadmin-theme/assets/images/users/3.jpg') }}"
                    ...
                    <a href="javascript:void(0)">
                        <div class="user-img"> <img
                                src="{{ asset('assets/dashboard/eliteadmin-theme/assets/images/users/4.jpg') }}"
